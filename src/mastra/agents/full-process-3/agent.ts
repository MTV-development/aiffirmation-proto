...
export async function createFullProcess3Agent(implementation: string = 'default'): Promise<Agent> {
  const systemPrompt = await getAgentSystemPrompt('fp-03', implementation);
