...
Affirmation: Creates deeply meaningful, psychologically effective affirmations based on the user's guided discovery conversation (steps 4-7). Handles variable exchange counts: 2-4 exchanges depending on skip/optional steps.`,
  ...
  {
    key: 'versions.fo-11._info.Trinev2',
    value: {
      name: 'Default',
      text: `FO-11: Intent-Based Guided Discovery + Affirmation Generation
...
Affirmation: Creates deeply meaningful, psychologically effective affirmations based on the user's guided discovery conversation (steps 4-7). Handles variable exchange counts: 2-4 exchanges depending on skip/optional steps.`,
  ...
  {
    key: 'versions.fo-11._model_name_affirmation.Trinev2',
    value: {
      text: 'openai/gpt-4o',
    },
  },
  ...
  {
    key: 'versions.fo-11._model_name.Trinev2',
    value: {
      text: 'openai/gpt-4o',
    },
  },
  ...
  {
    key: 'versions.fo-11._temperature_affirmation.Trinev2',
    value: {
      text: '0.9',
    },
  },
  ...
  {
    key: 'versions.fo-11._temperature.Trinev2',
    value: {
      text: '0.8',
    },
  },
...
Return ONLY a JSON array of exactly 5 affirmation strings.`,
  ...
  {
    key: 'versions.fo-11.prompt_affirmation_with_feedback.Trinev2',
    value: {
      text: `Generate 5 NEW personalized affirmations for {{ name }}.
...
Return ONLY a JSON array of exactly 5 affirmation strings.`,
  ...
  {
    key: 'versions.fo-11.prompt_affirmation.Trinev2',
    value: {
      text: `Generate 5 personalized affirmations for {{ name }}.
...
Return ONLY valid JSON:
{
  ...
  {
    key: 'versions.fo-11.prompt_step_5.Trinev2',
    value: {
      text: `## User Context
Name: {{ name }}
...
2. Formulate a question about what tone of support {{ name }} wants. Reference the SPECIFIC details they shared (situations, feelings, challenges) — not the initial goal label. For example, if they said "Courage" as goal but then revealed they're afraid of heights, reference the fear of heights, not "courage."
...
Return ONLY valid JSON:
{
  ...
  {
    key: 'versions.fo-11.prompt_step_6.Trinev2',
    value: {
      text: `## User Context
Name: {{ name }}
...
Return ONLY valid JSON:
{
  ...
  {
    key: 'versions.fo-11.prompt_step_7.Trinev2',
    value: {
      text: `## User Context
Name: {{ name }}
...
No explanations, no other text — just the JSON array.`,
  ...
  {
    key: 'versions.fo-11.system_affirmation.Trinev2',
    value: {
      text: `You are an expert affirmation coach who creates deeply meaningful, psychologically effective affirmations. Your unique strength is understanding users through their conversational journey - extracting emotional nuance, inner dialogue patterns, and personal context from natural exchanges.
...
No explanations, no markdown code blocks — just the JSON object.`,
  ...
  {
    key: 'versions.fo-11.system.Trinev2',
    value: {
      text: `You are a guided discovery agent for a personalized affirmation app. Your role is to formulate adapted questions and generate contextual response chips for each discovery step, based on the user's previous answers.
