...
export const fo13Seeds: SeedEntry[] = [
  {
    key: 'versions.fo-13._info.default',
    value: {
      name: 'Default',
      text: `FO-13: Production Onboarding with Feedback-Driven Affirmation Batches

Discovery: Same as FO-12 — generates adapted questions, contextual chips, and skip signals for steps 4-5.
- Step 4 (Context): Hybrid fragments ending with "..." — skippable if goal answer is rich
- Step 5 (Tone): Single-word chips — never skipped

Affirmation: Creates deeply meaningful, psychologically effective affirmations based on the user's guided discovery conversation (steps 3-5). Handles variable exchange counts: 2-3 exchanges depending on skip.

Phase 1: 4 batches of 5 affirmations with feedback-driven regeneration between each batch. Counter: X of 20.
Phase 2: 1 batch of 20 affirmations (optional — user can skip via "Add more later"). Counter: X of 40.
8 thinking screens with sequential personalized messages between transitions.`,
      author: 'System',
      createdAt: '2026-02-27',
    },
  },
  {
    key: 'versions.fo-13._model_name_affirmation.default',
    value: {
      text: 'openai/gpt-4o',
    },
  },
  {
    key: 'versions.fo-13._model_name.default',
    value: {
      text: 'openai/gpt-4o',
    },
  },
  {
    key: 'versions.fo-13._temperature_affirmation.default',
    value: {
      text: '0.9',
    },
  },
  {
    key: 'versions.fo-13._temperature.default',
    value: {
      text: '0.8',
    },
  },
  {
    key: 'versions.fo-13.prompt_affirmation_with_feedback.default',
    value: {
...
Return ONLY a JSON array of exactly {{ batch_size }} affirmation strings.`,
  ...
  {
    key: 'versions.fo-13.prompt_affirmation.default',
    value: {
...
Return ONLY a JSON array of exactly 5 affirmation strings.`,
  ...
  {
    key: 'versions.fo-13.prompt_step_4.default',
    value: {
      text: `## User Context
Name: {{ name }}
...
Return ONLY valid JSON:
{
  ...
  {
    key: 'versions.fo-13.prompt_step_5.default',
    value: {
      text: `## User Context
Name: {{ name }}
...

{
  ...
  {
    key: 'versions.fo-13.system_affirmation.default',
    value: {
...
All are valid — the user may have provided enough context in their goal answer that the context question was skipped.
...
- The initial goal label (first response) → general direction only, mentioned in at most 1 affirmation per batch
...
Return ONLY a JSON array of affirmation strings matching the requested count. No explanations, no other text — just the JSON array.`,
    },
  },
  {
    key: 'versions.fo-13.system.default',
    value: {
