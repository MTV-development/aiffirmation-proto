...
export const fo14Seeds: SeedEntry[] = [
  {
    key: 'versions.fo-14._info.default',
    value: {
      name: 'Default',
      text: `FO-14: Production Onboarding with Feedback-Driven Affirmation Batches
...
8 thinking screens with sequential personalized messages between transitions.`,
  ...
  {
    key: 'versions.fo-14._model_name_affirmation.default',
    value: {
      text: 'openai/gpt-4o',
    },
  },
  {
    key: 'versions.fo-14._model_name.default',
    value: {
      text: 'openai/gpt-4o',
    },
  },
  {
    key: 'versions.fo-14._temperature_affirmation.default',
    value: {
      text: '0.9',
    },
  },
  {
    key: 'versions.fo-14._temperature.default',
    value: {
      text: '0.8',
    },
  },
  {
    key: 'versions.fo-14.prompt_affirmation_with_feedback.default',
    value: {
...
Return ONLY a JSON array of exactly {{ batch_size }} affirmation strings.`,
  ...
  {
    key: 'versions.fo-14.prompt_affirmation.default',
    value: {
...
Return ONLY a JSON array of exactly 5 affirmation strings.`,
  ...
  {
    key: 'versions.fo-14.prompt_step_4.default',
    value: {
      text: `## User Context
Name: {{ name }}
...
Return ONLY valid JSON:
{
  ...
  {
    key: 'versions.fo-14.prompt_step_5.default',
    value: {
      text: `## User Context
Name: {{ name }}
...

{
  ...
  {
    key: 'versions.fo-14.system_affirmation.default',
    value: {
...
Return ONLY a JSON array of affirmation strings matching the requested count. No explanations, no other text — just the JSON array.`,
  ...
  {
    key: 'versions.fo-14.system.default',
    value: {
