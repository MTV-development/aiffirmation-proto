/**
 * FO-14 Types and Constants
 *
 * Shared types and constants for the FO-14 onboarding flow.
...
/**
 * Onboarding data accumulated during FO-14 flow.
 ...
 */
export interface FO14OnboardingData {
  name: string;
 ...
 */
export interface FO14GenerateBatchResult {
  affirmations: string[];
  error?: string;
}
