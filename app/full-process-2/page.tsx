...
import { DiscoveryWizard } from '@/components/full-process-2/discovery-wizard';
import { AffirmationReview } from '@/components/full-process-2/affirmation-review';
import { CollectionSummary } from '@/components/full-process-2/collection-summary';
import { MidJourneyCheckIn } from '@/components/full-process-2/mid-journey-checkin';
import { AdjustmentPanel } from '@/components/full-process-2/adjustment-panel';
import { generateFullProcess2Affirmations } from './actions';
...
export default function FullProcess2Page() {
  ...
  const handleDiscoveryComplete = async (prefs: UserPreferences) => {
    ...
    try {
      // FP-02: Pass feedback data (empty on first batch)
