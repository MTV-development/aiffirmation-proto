...
/**
 * Screen 11 for FO-13: Theme selection (UI mockup).
 *
 * Same as FO-12's StepBackground — gradient picker with local state only.
 */
export function StepTheme({ onContinue }: StepThemeProps) {
