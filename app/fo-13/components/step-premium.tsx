...
/**
 * Screen 13 for FO-13: Premium/Paywall (UI mockup).
 *
 * Copy of FO-12's StepPaywall — both CTAs proceed to next step.
 */
export function StepPremium({ onContinue }: StepPremiumProps) {
  return (
