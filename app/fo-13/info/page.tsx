...
export default function FO13InfoPage() {
  return (
    <InfoPageWrapper id="FO-13" name="Production Onboarding" tagline="Feedback-driven batches with thinking transitions">
      <InfoSummaryBox>
        FO-13 evolves FO-12&apos;s structured selection into a production-ready onboarding flow. Phase 1
      ...
      <section className="mb-8 p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-800 rounded-lg">
        ...
        <p className="text-amber-700 dark:text-amber-400">
          FO-13 uses FO-12 as its base, keeping the hybrid discovery approach (static goal + LLM-adapted
      ...
      <TechnicalDetails>
        <p>KV Namespace: <code className="bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded">versions.fo-13.*</code></p>
