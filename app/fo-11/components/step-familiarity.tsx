...
const FAMILIARITY_OPTIONS: { value: FamiliarityLevel; label: string }[] = [
  { value: 'new', label: 'New' },
  { value: 'somewhat', label: 'Some experience' },
  { value: 'very', label: 'Very familiar' },
];

/**
 * Familiarity step (Step 3) for FO-11 onboarding
 *
 ...
 * Note: Familiarity is cosmetic only in FO-11 — value is not passed to agents.
 */
