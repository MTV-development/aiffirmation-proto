...
import { FO11_GOAL_QUESTION } from '../types';
...
/**
 * Goal step (Step 4) for FO-11 onboarding.
 *
 * Features:
 * - Question display with user's name
 * - Prominent text input field
 * - Predefined topic chips (same as FO-10)
...
export function StepGoal({
  ...
  const question = FO11_GOAL_QUESTION.replace('[name]', name);
