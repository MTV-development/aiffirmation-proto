...
/**
 * Completion screen for FO-12
 *
 * Final screen showing the user's complete list of 30 loved affirmations.
  ...
  return (
    <div className="max-w-md mx-auto p-8">
      <h2 className="text-2xl font-medium mb-2 text-gray-800 dark:text-gray-200 text-center">
        You are all set, {name} — here are your {approvedAffirmations.length} affirmations!
      </h2>
