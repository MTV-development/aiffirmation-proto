...
/** The fixed goal question. Includes [name] placeholder for personalization. */
const GOAL_QUESTION = "What's your main goal with affirmations today, [name]?";
...
/**
 * Goal step for FO-12 onboarding.
 *
 * Features:
...
export function StepGoal({
  ...
  const question = GOAL_QUESTION.replace('[name]', name);
