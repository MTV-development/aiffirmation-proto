...
/**
 * Welcome steps (0-2) for FO-02 onboarding
 *
  ...
  if (currentStep === 2) {
    return (
      <div className="max-w-md mx-auto p-8 text-center">
        <p className="text-2xl font-medium mb-8 text-gray-800 dark:text-gray-200">
          Welcome, {name} 💛 Let&apos;s create affirmations that feel right for you.
        </p>
        <button
          onClick={onContinue}
          className="px-8 py-3 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 transition-colors"
