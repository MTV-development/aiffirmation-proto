...
import { FOCUS_AREAS } from '@/src/full-process';
 ...
 * Single-select from 6 preset cards OR custom text input
...
export function StepFocus({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <label htmlFor="custom-focus" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
          Enter your own focus
        </label>
        <input
          id="custom-focus"
          type="text"
